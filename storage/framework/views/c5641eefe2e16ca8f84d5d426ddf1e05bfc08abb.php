                ...
                <div class="card card-primary">
                    <div class="card-body">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center"><?php echo app('translator')->get('Account Status'); ?>
                                <span
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center"><?php echo app('translator')->get('Profile Status'); ?>
                                <span class="badge badge-pill <?php echo e(optional($user->profileInfo)->status == 0 ? 'badge-danger' : 'badge-success'); ?>">
                                    <?php echo e(optional($user->profileInfo)->status == 0 ? 'Pending' : 'Approved'); ?>
                        ...
                        <div class="btn-list ">
                            <?php if(adminAccessRoute(config('role.user_management.access.view'))): ?>
                                ...
                                <a href="<?php echo e(route('admin.user.fundLog',$user->id)); ?>"
                                   class="btn btn-info btn-sm">
                                    <span class="btn-label"><i
                                            class="fas fa-money-bill-alt"></i></span> <?php echo app('translator')->get('Payment Log'); ?>
                                </a>
                            <?php endif; ?>
                            ...
                            <?php if(adminAccessRoute(config('role.user_management.access.edit'))): ?>
                                ...
                                >
                                    <i class="fas fa-sign-in-alt"></i> <?php echo app('translator')->get('Login as User'); ?>
                                </a>
                            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        <input class="form-control" type="text" name="phone" value="<?php echo e($user->phone); ?>" maxlength="10" pattern="[0-9]{10}" placeholder="Enter 10 digit phone number">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="submit-btn-wrapper mt-md-3 text-center text-md-left">
                                <button type="submit" class="btn waves-effect waves-light btn-rounded btn-primary btn-block">
                                    <span><?php echo app('translator')->get('Update Password'); ?></span>
                                </button>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\RSL_Intern_T\Matrimony\resources\views/admin/users/edit-user.blade.php ENDPATH**/ ?>