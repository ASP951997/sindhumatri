<div class="notification-panel pe-3" id="pushNotificationArea">
    ...
    <ul class="notification-dropdown">
        ...
        <div class="clear-all fixed-bottom">
            <a href="javascript:void(0)" v-if="items.length == 0"><?php echo app('translator')->get('You have no notifications'); ?></a>
            <a href="javascript:void(0)" v-if="items.length > 0" @click.prevent="readAll"><?php echo app('translator')->get('Clear all'); ?></a>
        </div>
    </ul>
</div>

<?php /**PATH E:\RSL_Intern_T\Matrimony\resources\views/themes/deepblue/partials/pushNotify.blade.php ENDPATH**/ ?>