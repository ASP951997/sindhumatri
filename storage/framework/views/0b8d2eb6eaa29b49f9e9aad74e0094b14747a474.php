...
.card-body .img-box img {
  -webkit-transition: 0.4s;
  transition: 0.4s;
}

.card-body .img-box .hover-content {
  position: absolute;
  display: block;
...
.card-body .img-box .hover-content .text-box {
  color: var(--black);
  font-size: 18px;
  font-weight: 500;
...
.card-body .img-box .hover-content .text-box h5 {
  margin-bottom: 0;
}

.card-body .img-box .hover-content .text-box:hover {
  color: var(--secondary);
}

.card-body .img-box:hover img {
  -webkit-transform: scale(1.1);
          transform: scale(1.1);
}

.card-body .img-box:hover .hover-content {
  opacity: 1;
}

.card-body #masonryContainer {
  width: 100%;
}
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" name="search" value="<?php echo e(@request()->search); ?>" class="form-control"
                                       placeholder="<?php echo app('translator')->get('Name, Email, or Username'); ?>">
                            </div>
                        </div>
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?php echo app('translator')->get('User\'s Name'); ?></th>
                        ...
                        <th scope="col"><?php echo app('translator')->get('KYC Docs'); ?></th>
                        <th scope="col"><?php echo app('translator')->get('User Status'); ?></th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td data-label="<?php echo app('translator')->get('Profile Status'); ?>">
                                <span
                                    class="badge badge-pill <?php echo e(optional($user->profileInfo)->status == 0 ? 'badge-danger' : 'badge-success'); ?>"><?php echo e(optional($user->profileInfo)->status == 0 ? 'Pending' : 'Approved'); ?>

                                </span>
                            </td>
							<td data-label="<?php echo app('translator')->get('KYC docs'); ?>">
							<div style="display: flex; justify-content: space-around;">
								<div class="img-box"><img src="<?php echo e(getFile(config('location.kyc.path').$user->aadhar)); ?>" alt="<?php echo app('translator')->get('user aadhar'); ?>" class="rounded-rectagle" width="45" height="45">
								<div class="hover-content cursorDefault">
                    <div class="text-box">
                        <a href="<?php echo e(getFile(config('location.kyc.path').$user->aadhar)); ?>" data-fancybox="single" class="mx-2 iconHoverBg">
                            <i class="fas fa-search-plus"></i>
                        </a>
                    </div>
                </div>
								</div>
								<div class="img-box"><img src="<?php echo e(getFile(config('location.kyc.path').$user->pan)); ?>" alt="<?php echo app('translator')->get('user pan'); ?>" class="rounded-rectagle" width="45" height="45">
								<div class="hover-content cursorDefault">
								 <div class="text-box">
								<a href="<?php echo e(getFile(config('location.kyc.path').$user->pan)); ?>" data-fancybox="single" class="mx-2 iconHoverBg">
									<i class="fas fa-search-plus"></i>
								</a>
								</div>
								</div>
                            ...
                            <td data-label="<?php echo app('translator')->get('User Status'); ?>">
                                <span
                                    class="badge badge-pill <?php echo e($user->status == 0 ? 'badge-danger' : 'badge-success'); ?>"><?php echo e($user->status == 0 ? 'Inactive' : 'Active'); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\RSL_Intern_T\Matrimony\resources\views/admin/users/list.blade.php ENDPATH**/ ?>