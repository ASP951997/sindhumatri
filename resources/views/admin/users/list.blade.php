                ...
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    @forelse($users as $user)
                        <tr>
							...
							<td data-label="@lang('KYC docs')">
							<div style="display: flex; justify-content: space-around;">
								<div class="img-box"><img src="{{getFile(config('location.kyc.path').$user->aadhar)}}" alt="@lang('user aadhar')" class="rounded-rectagle" width="45" height="45">
								<div class="hover-content cursorDefault">
                    <div class="text-box">
                        <a href="{{getFile(config('location.kyc.path').$user->aadhar)}}" data-fancybox="single" class="mx-2 iconHoverBg">
                            <i class="fas fa-search-plus"></i>
                        </a>
                    </div>
                </div>
								</div>
								<div class="img-box"><img src="{{getFile(config('location.kyc.path').$user->pan)}}" alt="@lang('user pan')" class="rounded-rectagle" width="45" height="45">
								<div class="hover-content cursorDefault">
								 <div class="text-box">
								<a href="{{getFile(config('location.kyc.path').$user->pan)}}" data-fancybox="single" class="mx-2 iconHoverBg">
									<i class="fas fa-search-plus"></i>
								</a>
								</div>
								</div>
