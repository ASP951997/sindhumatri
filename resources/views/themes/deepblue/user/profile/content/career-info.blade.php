                ...
                <div class="col-md-12">
                    <div class="table-wrapper table-responsive">
                        <table class="table table-striped">
                            <thead>
                            <tr>
                                <th scope="col">@lang('Profession Area')</th>
                            ...
                            @forelse($careerInfo as $data)
                                <tr>
                                    ...
                                    <td>{{html_entity_decode($data->designation)}}</td>
                                    <td>{{html_entity_decode($data->company)}}</td>
                                   <!-- <td>@if(isset($data->start))
                                            {{dateTime(@$data->start,'d M, Y')}}
                                        @else
                                            @lang('N/A')
                                        @endif</td>
                                    <td>
            ...
            <div class="modal-content">
                ...
                <form action="{{route('user.careerInfoCreate')}}" method="post">
					...
					<div class="form-group">
                        <label for="area">@lang('Profession Area')</label> <span class="text-danger">*</span>
