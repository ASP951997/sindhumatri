                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <!-- <input type="number" name="max_height" id="max_height" value="{{old('max_height',request()->max_height)}}" class="form-control" min="1" placeholder="@lang('Max Height')"/> -->
										 <select class="form-select" name="max_height" aria-label="max_height">
							<option value="" selected>@lang('Select Height')</option>
							@for ($ft = 4; $ft <= 7; $ft++)
								@for ($in = 0; $in < 12; $in++)
									...
									@endphp
									<option value="{{ $ft . 'ft ' . $in . 'in' }}" {{ old('max_height',request()->max_height) == ($ft . 'ft ' . $in . 'in') ? 'selected' : '' }}>
										{{ $heightString }}
									</option>
								@endfor
							@endfor
                                    ...
                                    <div class="col-md-12 form-group">
										...
										<select class="form-select" name="min_height" aria-label="min_height">
							<option value="" selected>@lang('Select Height')</option>
							@for ($ft = 4; $ft <= 7; $ft++)
								@for ($in = 0; $in < 12; $in++)
									@if ($ft == 4 && $in < 5) @continue @endif
									...
									@php
										...
										$heightString = $ft . 'ft ' . $in . 'in (' . $heightInCm . ' cm)';
									@endphp
									<option value="{{ $ft . 'ft ' . $in . 'in' }}" {{ old('min_height',request()->min_height) == ($ft . 'ft ' . $in . 'in') ? 'selected' : '' }}>
										{{ $heightString }}
									</option>
								@endfor
							@endfor
                        ...
                        @forelse($allUser as $key => $data)
                            ...
                            <div class="member-box d-md-flex">
                                <div class="img-box">
									...
									<a href="{{getFile(config('location.user.path').$data->image)}}" data-fancybox="single" class="mx-2 iconHoverBg">
