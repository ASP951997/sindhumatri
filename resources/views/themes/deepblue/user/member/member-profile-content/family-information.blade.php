            ...
            <div class="row">
                <div class="col-md-6 borderTableOutline">
                    <ul class="list-group list-group-flush">
						...
						<li class="list-group-item list-group-item-action list d-flex justify-content-between align-items-center listStriped">
                            <span class="lebel w-45">@lang('No. Of Married Brothers') :</span>
                            <span>@lang($userProfile->brother_married)</span>
                        </li>
                        <li class="list-group-item list-group-item-action list d-flex justify-content-between align-items-center">
                            <span class="lebel w-45">@lang('No. Of Married Sisters') :</span>
                            <span>@lang($userProfile->sister_married)</span>
                        </li>
                        <li class="list-group-item list-group-item-action list d-flex justify-content-between align-items-center listStriped">
						...
						<li class="list-group-item list-group-item-action list d-flex justify-content-between align-items-center listStriped">
                            <span class="lebel w-45">@lang('Family Income') :</span>
                            <span>@lang($userProfile->family_income)</span>
                        </li>
                    </ul>
                </div>
            </div>
