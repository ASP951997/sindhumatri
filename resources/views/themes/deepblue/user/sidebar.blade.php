    ...
    <div class="sidebar">
        <div class="profile">
			...
			<div class="hover-content cursorDefault">
									...
									<a href="{{getFile(config('location.user.path').auth()->user()->image)}}" data-fancybox="single" class="mx-2 iconHoverBg">
			...
			<div class="hover-content cursorDefault">
													...
													<div class="text-box position-absolute top-50 start-20">
									<a href="{{getFile(config('location.default'))}}" data-fancybox="single" class="mx-2 iconHoverBg">
										<i class="fas fa-expand"></i>
									</a>
								</div>
                                                </div>
			...
			<h5>@lang(auth()->user()->member_id)</h5>
        </div>
