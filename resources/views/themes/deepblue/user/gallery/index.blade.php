...
@section('content')
                                                ...
                                                <div class="hover-content cursorDefault">
                                                    <div class="text-box">
														...
														<a href="javascript:void(0)"
														   ...
														   data-bs-toggle="modal"
														   data-route="{{ route('user.gallery.profile',$data->id) }}"
    ...
    <div id="delete-modal" class="modal fade modal-with-form" tabindex="-1" aria-hidden="true">
	 ...
	 <!-- Profile image Modal -->
    <div id="profile-image-modal" class="modal fade modal-with-form" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content form-block">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Profile Image Confirmation')</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>@lang('Are Your Sure To Set This Image As Profile?')</p>
                </div>
                <div class="modal-footer"> 
                    <button type="button" class="btn-flower2 btn1" data-bs-dismiss="modal">@lang('Close')</button>
                    <form action="" method="post" class="profileImageRoute">
                        @csrf
                        @method('put')
...
@push('script')
    <script>
		...
		$(document).on('click', '#profileImage', function () {
            ...
            $('.profileImageRoute').attr('action', route);
			$('#profile_image').val(imagesrc);
