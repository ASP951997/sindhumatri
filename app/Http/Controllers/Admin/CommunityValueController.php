...
class CommunityValueController extends Controller
{
    ...
    public function communityValueStore(Request $request, $language){
        ...
        $communityValue->details()->create([
			...
			'template'        => $purifiedData["template"][$language],
        ]);

        return redirect()->route('admin.communityValueList')->with('success', 'Template Saved Successfully');
    }
    ...
    public function communityValueUpdate(Request $request, $id, $language_id){
        ...
        $communityValue->details()->updateOrCreate([
            ...
            [
				...
				'template' => $purifiedData["template"][$language_id],
            ]
        );

        return redirect()->route('admin.communityValueList')->with('success', 'Template Successfully Updated');
    }
    ...
    public function communityValueDelete($id){
        ...
        return back()->with('success', 'Template has been deleted');
    }
